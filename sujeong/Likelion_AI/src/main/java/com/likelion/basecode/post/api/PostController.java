...
public class PostController {
    ...
    public ApiResTemplate<PostInfoResponseDto> deleteImageOnly(@PathVariable Long postId) {
        PostInfoResponseDto postInfoResponseDto = postService.deleteImageOnly(postId);
        return ApiResTemplate.successResponse(SuccessCode.POST_UPDATE_SUCCESS, postInfoResponseDto);
    }
